...
<head>
  ...
  <!--地址栏和标签上显示图标-->
  <link rel="Shortcut Icon" href="/eyas/image/img_logo_p16.png" />
  <!--收藏夹显示图标-->
  ...
  <link rel="stylesheet" type="text/css" href="/eyas/page/main/css/nav-style.css"/>
  <!-- layout css -->
  <link rel="stylesheet" type="text/css" href="/eyas/css/layout.css">
  <link rel="stylesheet" type="text/css" href="/eyas/css/prompt.css"/>
</head>
<body class="easyui-layout" data-options="fit:true">
  ...
  <div class="north" data-options="region:'north',border:false">
    ...
    <ul class="content clearfix">
      <li><a href="/eyas/page/xtgl/yhgl/yhgl.jsp" target='iframe_main'>首页</a></li>
      <li class="dropdown"><a href="javascript: void(0);">资源中心</a>
        <ul class="sub-menu">
          <li><a href='/eyas/page/dtzy/fwlb/fwlb.jsp'
            target='iframe_main'>服务管理</a></li>
          <li><a href='/eyas/page/dtzy/rwgl/rwgl.jsp'
            target='iframe_main'>任务管理</a></li>
          <li><a href='/eyas/page/dtzy/zygl/zygl.jsp'
            target='iframe_main'>资源管理</a></li>
          <li><a href='/eyas/page/kfzx/bzgf/bzgf.jsp'
            target='iframe_main'>标准规范</a></li>
        </ul></li>
      <li class="dropdown"><a href="javascript: void(0);">开发中心</a>
        <ul class="sub-menu">
          <li><a href='/eyas/page/kfzx/jtzt/jtzt.jsp'
            target='iframe_main'>交通专题服务</a></li>
          <li><a href='/eyas/page/bzzx/cjwt/cjwt.jsp'
            target='iframe_main'>常见问题</a></li>
          <li><a href='/eyas/page/bzzx/yhfk/yhfk.jsp'
            target='iframe_main'>用户反馈</a></li>
        </ul></li>
      <li class="dropdown"><a href="javascript: void(0);">监控中心</a>
        <ul class="sub-menu">
          <li><a href='/eyas/page/jkzx/yhrz/yhrz.jsp'
            target='iframe_main'>用户日志</a></li>
          <li><a href='/eyas/page/jkzx/fwrz/fwrz.jsp'
            target='iframe_main'>访问日志</a></li>
          <li><a href='/eyas/page/jkzx/fwjk/fwjk.jsp'
            target='iframe_main'>服务监控</a></li>
          <li><a href='/eyas/page/jkzx/fwtj/fwtj.jsp'
      ...
      <li class="dropdown"><a href="javascript: void(0);">系统管理</a>
        <ul class="sub-menu">
          ...
          <li><a href='/eyas/page/xtgl/jsgl/jsgl.jsp'
            target='iframe_main'>角色管理</a></li>
          <li><a href='/eyas/page/xtgl/fbsz/fbsz.jsp'
            target='iframe_main'>发布设置</a></li>
          <li><a href='/eyas/page/xtgl/sjapp/sjapp.jsp'
            target='iframe_main'>apk更新</a></li>
        </ul></li>
       <li class="dropdown"><a id="username"></a>
       <ul class="sub-menu">
          <li><a href='/eyas/page/wdxx/wdxx.jsp'
 ...
 <!-- 中间主要内容iframe -->
  ...
  <!-- pluging js -->
  <script type="text/javascript" src="/eyas/framework/jquery/jquery.cookie.js"></script>
  <script type="text/javascript" src="/eyas/page/main/js/jquery.navHover.min.js"></script>
  <!-- index js -->
  <script type="text/javascript" src="/eyas/js/utils/YMLib.js"></script>
  <script type="text/javascript" src="/eyas/js/MyUtil.js"></script>
  <script type="text/javascript" src="/eyas/js/index.js"></script>
